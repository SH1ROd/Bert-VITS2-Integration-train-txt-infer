        ...
        if rank == 0:
            ...
            if global_step % hps.train.eval_interval == 0:
                ...
                if global_step % 1000 == 0:
                    utils.save_checkpoint(net_g, optim_g, hps.train.learning_rate, epoch,
                                          os.path.join("./tmp_save/", "G_{}.pth".format(global_step)))
                if net_dur_disc is not None:
                ...
                if keep_ckpts > 0:
                    utils.clean_checkpoints(path_to_models=hps.model_dir, n_ckpts_to_keep=keep_ckpts, sort_by_time=True, role=role)
